...
class getAnnoncesRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AnnoncesRepository.php';

        return $container->privates['App\\Repository\\AnnoncesRepository'] = new \App\Repository\AnnoncesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
