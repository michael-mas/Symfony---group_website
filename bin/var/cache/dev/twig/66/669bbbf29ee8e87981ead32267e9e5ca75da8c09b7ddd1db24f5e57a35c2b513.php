...
class __TwigTemplate_7c13e42ffcdc8df13c538476759df3f55ea7e673eaa5b86f4943d0702c68cf4b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  139 => 37,  136 => 31,  130 => 24,  122 => 19,  117 => 16,  107 => 13,  104 => 12,  102 => 11,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            You are logged in as {{ app.user.nom }} {{ app.user.prenom }}, <a href=\"{{ path('app_logout') }}\">Logout</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\Hipskor\\Hipskor\\templates\\security\\login.html.twig");
    }
}
