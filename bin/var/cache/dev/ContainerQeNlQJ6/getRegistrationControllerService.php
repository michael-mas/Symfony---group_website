...
class getRegistrationControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.8E49MYa'] ?? $container->load('get_ServiceLocator_8E49MYaService'))->withContext('App\\Controller\\RegistrationController', $container));
