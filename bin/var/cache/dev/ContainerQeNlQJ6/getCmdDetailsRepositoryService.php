 ...
 */
class getCmdDetailsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CmdDetailsRepository' shared autowired service.
     *
     * @return \App\Repository\CmdDetailsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CmdDetailsRepository.php';

        return $container->privates['App\\Repository\\CmdDetailsRepository'] = new \App\Repository\CmdDetailsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
